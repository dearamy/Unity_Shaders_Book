...
public class ColorPicker : MonoBehaviour {
    [SerializeField] ScriptableRendererData _rendererData;
    ...
    void OnPostRender() {
        ...
        m_pickedColor =
            m_screenRenderTexture.GetPixel(Mathf.FloorToInt(m_pixelPosition.x),
